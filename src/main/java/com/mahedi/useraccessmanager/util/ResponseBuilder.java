package com.mahedi.useraccessmanager.util;

import com.mahedi.useraccessmanager.dto.ErrorResponseDto;
...
public final class ResponseBuilder {
    ...
    public static Response getDto(HttpStatus status, String message, Object content) {
        return Response.builder().message(message).status(status.getReasonPhrase())
                .statusCode(status.value()).content(content).timeStamp(new Date().getTime()).build();
    }
